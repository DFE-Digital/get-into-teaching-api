alerts =  {
ftt = {
    website_name = "Get Teacher Training API (Production)"
    website_url   = "https://get-into-teaching-api-production.london.cloudapps.digital/api/operations/health_check"
    test_type     = "HTTP"
    check_rate    = 60
