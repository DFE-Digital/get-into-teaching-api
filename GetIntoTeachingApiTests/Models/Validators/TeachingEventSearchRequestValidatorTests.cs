...
namespace GetIntoTeachingApiTests.Models.Validators
{
    public class TeachingEventSearchRequestValidatorTests
    {
        ...
        public TeachingEventSearchRequestValidatorTests()
        {
            ...
            _validator = new TeachingEventSearchRequestValidator(_mockCrm.Object, _mockPostcodeService.Object);
        }
        ...
        public void Validate_WhenValid_HasNoErrors()
        {
            ...
            _mockPostcodeService.Setup(mock => mock.IsValid("KY11 9HF")).Returns(true);
